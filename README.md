...
- Navigate to `nagarro-leave-manager` folder
- Select `nagarro-leave-manager.bot` file
...
msbot clone services --name "nagarro-leave-manager" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
